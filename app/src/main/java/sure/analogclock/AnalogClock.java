...
//        resolveSizeAndState(int size, int measureSpec, int childMeasuredState) 一个计算期望大小和状态的工具方法
//        参数size：View期望的大小,参数measureSpec：父View的measureSpec限制
...
//        我们在操作之前调用canvas.save()来保存画布当前的状态，当操作之后取出之前保存过的状态，这样就不会对其他的元素进行影响
        canvas.restore();
